...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?=('img/poli.png')?>">
  </head>
  <body>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 pt-5">
                                        <div class="text">
                                            <h1 style="color:black;">Selamat Datang Dokter</h1>
                                            <h2><span style="color:black; font-weight:bold;">Di Poliklinik Sehat Bahagia</span></h2>
                                            <h2><span style="color:black; font-weight:bold;">Hello, '. $_SESSION['nama'] .'</span></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
